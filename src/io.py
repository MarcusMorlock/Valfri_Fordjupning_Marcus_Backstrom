...
def save_csv (file_name: str, data: list[dict]) -> None:
    ...
    try:
        ...
        logger(f"Failed to convert data to DataFrame: {error}")
        raise ValueError("Could not convert data to DataFrame.") from error
